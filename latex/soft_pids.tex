...
Sposób optymalny w rozumieniu algorytmu jest to próba uzyskania przebiegu prędkości w zadanym odcinku w kształcie trapezu, co pozwala na płynny start i hamowanie (rys. \ref{grafiki/traj_trapez.eps}). W celu oszczędzenia pamięci operacyjnej mikrokontrolera kolejne punkty trajektorii są liczone na bieżąco podczas ,,podążania'' za trajektorią. Do jej wyznaczenia potrzebne są następujące dane:
